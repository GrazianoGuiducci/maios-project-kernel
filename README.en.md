...
> Draft generated by the system on August 14, 2026. **Not yet reviewed.**
...
The `1.3.0` series composed the Project Kernel into the package, introduced the
project meta-faculty and typed evolution contract, connected an initial need to
a first useful proof, and made context loading progressive. The `1.2.x` series
had strengthened integrity, novice orientation, and operational continuity
across hosts.
