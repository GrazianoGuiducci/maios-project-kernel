...
This `package/` folder is the generated installation distribution. `INSTALL.md` documents `install.py`;
...
Running the installer and the installed helper requires Python >=3.11 (qualified: 3.11–3.14 on Linux, Windows and macOS).
