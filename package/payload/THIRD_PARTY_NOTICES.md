...
MAIOS Project Kernel 3.1.3+coordination.1 is generated from the living sources in this
...
[`d-nd-ux-ai-seed`](https://github.com/GrazianoGuiducci/d-nd-ux-ai-seed) is a
related MAIOS ecosystem surface for agentic UX behavior contracts. It is not a
declared generation input and none of its source files is redistributed in the
...
owner-native organs and generates the 3.1.3+coordination.1 distribution. RepoKernel source,
