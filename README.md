...
It also preserves initial host and competence-state integrity and equivalent
project-root spellings during reentry. See the [3.2.0 release notes](docs/RELEASE_3.2.0.md)
and the [initial-state correction](docs/REVIEW_INITIAL_STATE.md).

MAIOS Project Kernel **3.2.0** makes competences living
...
This revision preserves selected knowledge references across fresh reentry,
keeps plural learning history independent of current recall, and validates
the original update baseline while allowing local knowledge to evolve. Source
...
Patch 3.1.3 keeps event input distinct from internal history metadata and
checks current host and competence-index state against the latest receipt.
Historical replay and the evolution of living competence bodies remain open.

The [review brief](docs/REVIEW_CONTINUUM.md) records the published 3.1.3 review;
its evidence belongs to the stated commit. See [the 3.1.3 corrections](docs/RELEASE_3.1.3.md).

[Versione italiana](README.it.md)

Product version: **[3.2.0](VERSION.md)**. Shared Project Kernel family:
`3.0.0`.
...
| --- | --- | --- |
| Establish current truth | [`AGENTS.md`](AGENTS.md), [`CURRENT_STATE.md`](CURRENT_STATE.md), [`VERSION.md`](VERSION.md), [`CHANGELOG.md`](CHANGELOG.md) | Product version `3.2.0`, family `3.0.0`, current evidence, boundaries, and the selected movement |
