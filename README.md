...
MAIOS Project Kernel **3.1.0** makes competences living
...
and identify the exact commit being read. See [what changed in 3.1.0](docs/RELEASE_3.1.0.md).

[Versione italiana](README.it.md)

Product version: **[3.1.0](VERSION.md)**. Shared Project Kernel family:
`3.0.0`.
...
| --- | --- | --- |
| Establish current truth | [`AGENTS.md`](AGENTS.md), [`CURRENT_STATE.md`](CURRENT_STATE.md), [`VERSION.md`](VERSION.md), [`CHANGELOG.md`](CHANGELOG.md) | Product version `3.1.0`, family `3.0.0`, current evidence, boundaries, and the selected movement |
