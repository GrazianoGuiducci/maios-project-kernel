...
| --- | --- | --- |
| Establish current truth | [`AGENTS.md`](../AGENTS.md), [`CURRENT_STATE.md`](../CURRENT_STATE.md), [`VERSION.md`](../VERSION.md), [`CHANGELOG.md`](../CHANGELOG.md) | Product version `4.1.0`, family `3.0.0`, current evidence, boundaries, and the selected movement |
