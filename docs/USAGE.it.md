...
e coder AI. Mostra dove vive ogni tipo di verità, cosa il prodotto può rendere
...
| --- | --- | --- |
| Stabilire la verità corrente | [`AGENTS.md`](../AGENTS.md), [`CURRENT_STATE.md`](../CURRENT_STATE.md), [`VERSION.md`](../VERSION.md), [`CHANGELOG.md`](../CHANGELOG.md) | Versione prodotto `4.1.0`, famiglia `3.0.0`, evidenze correnti, confini e movimento selezionato |
...
- forma o evolve competenze quando intento, conoscenza e possibilità emergenti le rendono utili.
...
| `maios-project-competence-formation` | Forma o evolve la più piccola competenza locale utile da intento, conoscenza, lavoro riuscito, possibilità emergenti o una lacuna concreta |
...
-> risultato, nuova conoscenza, possibilità o correzione
...
Intento, conoscenza, lavoro riuscito, possibilità emergenti o una lacuna
concreta possono rendere utile formare o evolvere una competenza. La facoltà
di formazione dà a quella capacità il corpo minimo utile: metodo, riferimento,
protocollo, funzione, skill o relazione di coordinamento.
Metodi e conoscenza restano posseduti dal progetto destinatario.
...
una migrazione in-place tra versioni del prodotto: applicare una versione diversa
non è una procedura di aggiornamento dell'installer.
