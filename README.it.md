...
MAIOS Project Kernel **3.1.2** porta competenze come fonti vive di sapere e metodo: il contesto e l'intento evolvono
...
e identifica il commit esatto che stai leggendo. Leggi le [correzioni della 3.1.2](docs/RELEASE_3.1.2.md).

[English version](README.md)

Versione del prodotto: **[3.1.2](VERSION.md)**. Famiglia Project
...
| --- | --- | --- |
| Stabilire la verità corrente | [`AGENTS.md`](AGENTS.md), [`CURRENT_STATE.md`](CURRENT_STATE.md), [`VERSION.md`](VERSION.md), [`CHANGELOG.md`](CHANGELOG.md) | Versione prodotto `3.1.2`, famiglia `3.0.0`, evidenze correnti, confini e movimento selezionato |
