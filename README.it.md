...
Questa candidata aggiunge [la competenza per coordinamento e continuità fra harness](docs/INSTANCE_COORDINATION.md). La release numerata resta **3.1.3**. La candidata non configura altri harness e non modifica il runtime con un solo adapter selezionato.

La [recensione finale della candidata](docs/REVIEW_COORDINATION.md) raccoglie
intento, differenze, evidenze e osservazioni ancora mancanti. Usa il commit esatto.

MAIOS Project Kernel **3.1.3+coordination.1** porta competenze come fonti vive di sapere e metodo: il contesto e l'intento evolvono
...
Questa revisione conserva i riferimenti alla conoscenza al nuovo rientro,
...
Il recupero ora distingue i file previsti da quelli effettivamente creati e
conserva quelli di provenienza incerta. Un'installazione completata rimane
intatta quando resta soltanto da rimuovere il giornale del tentativo.

La patch 3.1.3 distingue l'input degli eventi dai metadati della storia e
collega lo stato corrente di host e indice competenze all'ultima ricevuta.
Restano disponibili il replay storico e l'evoluzione dei corpi delle competenze.

Le [indicazioni di lettura](docs/REVIEW_CONTINUUM.md) registrano la recensione della 3.1.3 pubblicata;
le sue evidenze appartengono al commit indicato. Leggi le [correzioni della 3.1.3](docs/RELEASE_3.1.3.md).

[English version](README.md)

Versione del prodotto: **[3.1.3+coordination.1](VERSION.md)**. Famiglia Project
...
| --- | --- | --- |
| Stabilire la verità corrente | [`AGENTS.md`](AGENTS.md), [`CURRENT_STATE.md`](CURRENT_STATE.md), [`VERSION.md`](VERSION.md), [`CHANGELOG.md`](CHANGELOG.md) | Versione prodotto `3.1.3+coordination.1`, famiglia `3.0.0`, evidenze correnti, confini e movimento selezionato |
...
- la disinstallazione richiede la ricevuta corrente valida, rimuove soltanto
  file invariati posseduti dall'installer e conserva le directory dei progetti esistenti;
